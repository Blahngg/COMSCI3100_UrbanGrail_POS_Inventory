...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2024 at 11:55 AM
...
(7, 'Basic Pullover Hoodie', 'H&M', 'L-XL', '', 1200.00, 13, 2, 1, 999.00, 0),
...
(53, 'Stretchable Walking Shorts', 'Bench', 'XS-XL', '', 799.00, 78, 3, 1, 500.00, 0),
...
(63, 'Relaxed Fit Linen Pants', 'H&M', 'S-XL', '', 1399.00, 59, 4, 1, 950.00, 0),
(64, 'Black Dress Pants', 'Banana Republic', '30-40', '', 2999.00, 24, 4, 1, 2000.00, 0),
(65, 'Jogger Pants', 'Nike', 'S-XXL', '', 2299.00, 29, 4, 1, 1500.00, 0),
...
--
ALTER TABLE `sales`
  MODIFY `sale_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;

--
-- AUTO_INCREMENT for table `sale_items`
--
ALTER TABLE `sale_items`
  MODIFY `sale_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=404;
